...
<br><br>
<div class="well"><center style="color:#069;font-size:14px"><strong>Meru Hospice</strong></center></div>
<div class="container">
        <div class="row">
        	<div class="col-sm-3">
            	<p><button class="btn btn-success btn-block" id="compose">Compose</button></p>
            	<div class="list-group">
                	<a href="messages.php" class="list-group-item">Inbox <span style="float:right;" class="badge"><?php $func->Count_Received_Messages($doc_id,1); ?></span></a>
                    <a href="sent_messages.php" class="list-group-item active">Sent <span style="float:right;" class="badge"><?php $func->Count_Sent_Messages($doc_id,1); ?></span></a>
                </div>
            </div>
            <div class="col-sm-9">
            	...
            	<div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                    	<?php $func->Get_Sent_Messages($doc_id,1); ?>
                    </div>
                </div>
            </div>
        </div>
