        ...
        <div class="row">
        	<div class="col-sm-3">
            	...
            	<div class="list-group">
                    ...
                    <a href="sent_messages.php" class="list-group-item">Sent <span style="float:right;" class="badge"><?php $func->Count_Sent_Messages($doc_id,1); ?></span></a>
                </div>
            </div>
            <div class="col-sm-9">
            	...
            	<div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                    	<?php $func->Get_Inbox_Messages($doc_id,1); ?>
                    </div>
                </div>
            </div>
        </div>
