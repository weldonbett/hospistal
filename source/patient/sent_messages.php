        ...
        <div class="row">
        	<div class="col-sm-3">
            	...
            	<div class="list-group">
                	<a href="messages.php" class="list-group-item">Inbox <span style="float:right;" class="badge"><?php $func->Count_Received_Messages($pid,2); ?></span></a>
                    <a href="sent_messages.php" class="list-group-item active">Sent <span style="float:right;" class="badge"><?php $func->Count_Sent_Messages($pid,2); ?></span></a>
                </div>
            </div>
            <div class="col-sm-9">
            	...
            	<div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                    	<?php $func->Get_Sent_Messages($pid,2); ?>
                    </div>
                </div>
            </div>
        </div>
